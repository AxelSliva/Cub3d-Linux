...
void	ft_forward_back(t_recup *recup)
{
	...
	{
		if (recup->map[(int)(recup->ray.posx + (recup->ray.dirx * recup->ray.movespeed * 2))][(int)recup->ray.posy] == '0')
			recup->ray.posx += recup->ray.dirx * recup->ray.movespeed;
		if (recup->map[(int)(recup->ray.posx)][(int)(recup->ray.posy + (recup->ray.diry * recup->ray.movespeed * 2))] == '0')
...
void	ft_left_right(t_recup *recup)
{
	...
	{
		if (recup->map[(int)(recup->ray.posx + recup->ray.diry * (recup->ray.movespeed * 2))][(int)recup->ray.posy] == '0')
			recup->ray.posx += recup->ray.diry * recup->ray.movespeed;
		if (recup->map[(int)recup->ray.posx][(int)(recup->ray.posy - recup->ray.dirx * (recup->ray.movespeed * 2))] == '0')
